...
import Example1 from "../icons/EmailSocialExample.png";
...
class USGForm extends Component {
	...
	addStoriesToProject(e) {
        ...
        if (this.state.socialChecked) {
			...
			this.setState({
				error:
					"You specified you didn't want email signup and social section included. Please update."
			});
		}
	}
	handleChange = (name) => (event) => {
		this.setState({ socialChecked: event.target.checked });
	};
							...
							<FormControlLabel
								...
								control={
									<Switch
                                        ...
                                        onChange={this.handleChange("socialChecked")}
                                        value="socialChecked"
									/>
								}
								label={
                                    this.state.socialChecked
										? "Include Email Signup and Social Link Section? : True"
                                        : "Include Email Signup and Social Link Section?  : False"
								}
							/>
						</FormGroup>
					</div>
